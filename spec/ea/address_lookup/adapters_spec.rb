  ...
  describe "adapters" do
    describe "#adapter" do
      it "defaults to :address_facade" do
        ...
        expect(described_class.adapter.class).to eq(EA::AddressLookup::Adapters::AddressFacade)
      end
    end
    ...
    describe "#adpater=" do
      ...
      it "assigns a matching adapter class" do
        ...
        expect(described_class.adapter.class).to eq(EA::AddressLookup::Adapters::TestAdapter2)
      end

      it "raises an error nil passed" do
        expect { described_class.adapter = nil}.to raise_error(EA::AddressLookup::MissingAdapterError)
      end
